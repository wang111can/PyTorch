...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        self.conv2 = torch.nn.Conv2d(88, 20, kernel_size = 5) # input channel = 10, output channel = 20 , kernel size
        self.incep1 = InceptionA(in_channels=10) # 多尺度特征融合模块
        self.incep2 = InceptionA(in_channels=20) # 多尺度特征融合模块
